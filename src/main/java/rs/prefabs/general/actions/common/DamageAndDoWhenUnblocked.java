...
public class DamageAndDoWhenUnblocked extends AbstractPrefabGameAction {
    private AttackEffect effect;
    private Consumer<AbstractCreature> dowhat;

    public DamageAndDoWhenUnblocked(AbstractCreature target, PrefabDmgInfo info, AttackEffect effect, Consumer<AbstractCreature> dowhat) {
        this.target = target;
        this.info = info;
        this.effect = effect;
        this.dowhat = dowhat;
